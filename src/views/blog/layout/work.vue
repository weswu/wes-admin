<template>
  <div class="d-news bg">
    <div class="container">
      <JTitleSearch :title="'特色工作'" :value="searchData.title" @on-change="search"/>
      <main class="site__content">
        <section>
          <ul>
            <Item :item="item" v-for="item,index in list" :key="index" :type="'work'"/>
            <li v-if="total === 0" style="font-size: 14px;">暂无数据</li>
          </ul>
        </section>
      </main>
